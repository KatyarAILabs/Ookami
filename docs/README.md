...
Forge is open-source AI infrastructure that you host yourself, shipped as one package and configured by one `forge.yaml`. It covers:
- a gateway;
- model serving;
- fine-tuning;
- eval gates;
...
| [Configuration reference](reference/forge-yaml.md) | Every `forge.yaml` field (generated from the code) |
