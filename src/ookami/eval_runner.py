"""ookami eval: run the customer's evaluators on candidate and incumbent, pair by item, apply the gate, write a report.
...
class Report:
    ...
    def markdown(self) -> str:
        ...
        lines = [f"# ookami eval: {self.model}: {badge}", "",
...
def report_dir(cfg: Config, model: str) -> Path:
    """Reports go to the customer's storage when it is a local path; otherwise next to ookami.yaml."""
    ...
    if uri.startswith("file://"):
        ...
        base = cfg.base_dir / "ookami-reports"
