...
- **Verified on NVIDIA:** a full run on an A10G, covering vLLM serving, TRL training, the multi-LoRA gate, promote and gateway routing. Fixed the training step count and batch sizing that the run exposed.
